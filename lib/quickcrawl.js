...
module.exports = function crawl(url, successCallback, failCallback, options) {
    ...
    var tmpCrawler = new Crawler(url.hostname(), url.path(),
        url.port() || (url.protocol() === "https" ? 443 : 80), 250, options);
